...
function SidebarNav() {
  ...
  return (
    <div className={`border-r-2 h-full flex flex-col items-center text-center border-gray-400 w-[20%] ${isFixed ? 'fixed top-0 left-0 h-full bg-white border-r-2 border-gray-400 z-10' : 'absolute top-[100vh] left-0 bg-white'}`}>
      <h1 className="text-2xl font-serif text-black mt-10">I Will Show You</h1>
      {/* items items-1*/}
      ...
      <div className='mt-2 h-auto w-24 mr-[30%] flex flex-row'>
        ...
        <div className='border-2 border-purple-700 shadow-2xl w-[60%] flex items-center justify-center '>
      ...
      {/* items items-2*/}
      <div className='border-2 border-purple-500 rounded mt-2 w-20 mr-[30%]'>
        <div className='m-2 flex flex-col gap-1 text-center items-center'>
      ...
      {/* items items-3*/}
      <div className='border-2 border-purple-500 rounded mt-2 w-20 ml-[30%]'>
        <div className='m-2 flex flex-col gap-1 text-center items-center'>
